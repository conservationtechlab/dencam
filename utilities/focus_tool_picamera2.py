"""
Real-time blur detection tool for Raspberry Pi with PiCamera2.

This module captures video frames from the PiCamera, divides each
frame into grid cells, and calculates a blur variance score for each
cell. An overlay grid displays the blur score on top of the live camera
feed, with transparency and text options loaded from a configuration file.
"""
...
def update_frame(image_array, grid_dim, variance_history,
